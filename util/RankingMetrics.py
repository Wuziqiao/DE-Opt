...
def evaluate_test(self):
    ...
    for u in self.test_users:
        ...
        pred_ratings_20[u] = pred_ratings[u][:20]

        p_10, r_10, ndcg_10 = precision_recall_ndcg_at_k(10, pred_ratings_10[u], self.test_data[u])
        p_at_10.append(p_10)
        r_at_10.append(r_10)
        ndcg_at_10.append(ndcg_10)
        p_20, r_20, ndcg_20 = precision_recall_ndcg_at_k(20, pred_ratings_20[u], self.test_data[u])
        p_at_20.append(p_20)
        r_at_20.append(r_20)
        ndcg_at_20.append(ndcg_20)
