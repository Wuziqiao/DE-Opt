...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='ml1m',
                        help='Choose a dataset from {gowalla, Movietweetings, ml1m, Yahoo, Epinion, filmtrust, Yelp, ciaoDVD}')
    ...
    parser.add_argument('--validation_flag', nargs='?', default='part',
                        help='Specify the validation type from {part, full}, indicating whether the reference is done in mini-batch')
